...
run_duel_case "f80_timed_construction" "--duel-test-f80-timed-construction" "[F80] Summary"
run_duel_case "f81_production_queue" "--duel-test-f81-production-queue" "[F81] Summary"
run_duel_case "f82_queue_destruction" "--duel-test-f82-queue-destruction" "[F82] Summary"
run_duel_case "f83_public_queue_input" "--duel-test-f83-public-queue-input" "[F83] Summary"
run_duel_case "f84_rally_queue_contract" "--duel-test-f84-rally-queue-contract" "[F84] Summary"
run_duel_case "f85_ai_timed_queue" "--duel-test-f85-ai-timed-queue" "[F85] Summary"
run_duel_case "f86_public_data_capture" "--duel-test-f86-public-data-capture" "[F86] Summary"
run_duel_case "f87_data_lifecycle" "--duel-test-f87-data-lifecycle" "[F87] Summary"
run_duel_case "f88_data_benefit_feedback" "--duel-test-f88-data-benefit-feedback" "[F88] Summary"
run_duel_case "f89_objective_ai_endgame" "--duel-test-f89-objective-ai-endgame" "[F89] Summary"
