...
| T-0059 | M2 | P1 | Add minimal world blockers and no-go collision zones to validate path response and command rejection behavior | Level Design | S | T-0057 | Units do not pass through blocker volumes and invalid move targets show rejection feedback without crash | Todo |
