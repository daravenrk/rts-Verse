...
| T-0027 | M2 | P0 | Implement skirmish faction selection gate for all available factions with disabled Coming Soon entries for unavailable factions | Unassigned | M | T-0015, T-0024 | F-25 validates selectable available factions and disabled unavailable entries | Todo |
| T-0028 | M2 | P0 | Define and apply primary environment type for first duel map, including Helion center-Tether placement rule where relevant | Unassigned | M | T-0010, T-0023 | F-26 confirms environment readability and Helion anchor compliance | Todo |
