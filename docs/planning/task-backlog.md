...
| T-0017 | M2 | P0 | Implement keyboard and mouse control bindings from planning/controls-standards.md | Unassigned | M | T-0001, T-0002 | F-18 passes all command and group control checks | In Progress |
| T-0018 | M2 | P0 | Implement MVP HUD baseline: resource bar, minimap, command card, alerts, and queues | Unassigned | L | T-0004, T-0017 | F-19 passes camera and HUD synchronization checks | In Progress |
...
| T-0025 | M2 | P0 | Implement small-scale 3D unit presentation and predefined animation subspace baseline for MVP roster | Unassigned | L | T-0006, T-0014, T-0018 | F-24 passes for readability and required animation state coverage | In Progress |
...
| T-0028 | M2 | P0 | Define and apply primary environment type for first duel map; confirm Tether Points spawn at map-defined positions for all factions | Unassigned | M | T-0010, T-0023 | F-26 confirms environment readability and faction-agnostic spawn positions | In Progress |
